...
_lr_productions = [
  ...
  ('statement -> INTDEC NAME is_assing','statement',3,'p_statement_declare_int','main.py',63),
  ('is_assing -> = expression','is_assing',2,'p_is_assing','main.py',68),
  ('is_assing -> <empty>','is_assing',0,'p_is_assing','main.py',69),
  ('statement -> FLOATDEC NAME','statement',2,'p_statement_declare_float','main.py',75),
  ('statement -> PRINT ( expression )','statement',4,'p_statement_print','main.py',79),
  ('statement -> NAME = expression','statement',3,'p_statement_assign','main.py',83),
  ('statement -> expression','statement',1,'p_statement_expr','main.py',90),
  ('expression -> expression + expression','expression',3,'p_expression_binop','main.py',95),
  ('expression -> expression - expression','expression',3,'p_expression_binop','main.py',96),
  ('expression -> expression * expression','expression',3,'p_expression_binop','main.py',97),
  ('expression -> expression / expression','expression',3,'p_expression_binop','main.py',98),
  ('expression -> - expression','expression',2,'p_expression_uminus','main.py',106),
  ('expression -> ( expression )','expression',3,'p_expression_group','main.py',111),
  ('expression -> INUMBER','expression',1,'p_expression_inumber','main.py',116),
  ('expression -> FNUMBER','expression',1,'p_expression_fnumber','main.py',121),
  ('expression -> NAME','expression',1,'p_expression_name','main.py',126),
]
